...
export const _zapFileId = 0xa93fc509624c72d9n;
/**
...
*/
  get discriminantValue(): number {
    return $.utils.getUint16(2, this, Field._zap.defaultDiscriminantValue);
  }
  set discriminantValue(value: number) {
    $.utils.setUint16(2, value, this, Field._zap.defaultDiscriminantValue);
  }
  /**
* A regular, non-group, non-fixed-list field.
*
...
export class ZapVersion extends $.Struct {
  static readonly _zap = {
    displayName: "ZapVersion",
    id: "d85d305b7d839963",
  ...
  toString(): string { return "ZapVersion_" + super.toString(); }
}
...
export class CodeGeneratorRequest extends $.Struct {
  ...
  _adoptZapVersion(value: $.Orphan<ZapVersion>): void {
    $.utils.adopt(value, $.utils.getPointer(2, this));
  }
  _disownZapVersion(): $.Orphan<ZapVersion> {
    return $.utils.disown(this.zapVersion);
  }
  /**
...
*
*/
  get zapVersion(): ZapVersion {
    return $.utils.getStruct(2, ZapVersion, this);
  }
  _hasZapVersion(): boolean {
    return !$.utils.isNull($.utils.getPointer(2, this));
  }
  _initZapVersion(): ZapVersion {
    return $.utils.initStructAt(2, ZapVersion, this);
  }
  set zapVersion(value: ZapVersion) {
    $.utils.copyFrom(value, $.utils.getPointer(2, this));
  }
