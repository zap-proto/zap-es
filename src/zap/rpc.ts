...
export const _zapFileId = 0xb312981b2552a250n;
...
*/
  get allowThirdPartyTailCall(): boolean {
    return $.utils.getBit(128, this, Call._zap.defaultAllowThirdPartyTailCall);
  }
  set allowThirdPartyTailCall(value: boolean) {
    $.utils.setBit(128, value, this, Call._zap.defaultAllowThirdPartyTailCall);
  }
  /**
...
*/
  get noPromisePipelining(): boolean {
    return $.utils.getBit(129, this, Call._zap.defaultNoPromisePipelining);
  }
  set noPromisePipelining(value: boolean) {
    $.utils.setBit(129, value, this, Call._zap.defaultNoPromisePipelining);
  }
  /**
...
*/
  get onlyPromisePipeline(): boolean {
    return $.utils.getBit(130, this, Call._zap.defaultOnlyPromisePipeline);
  }
  set onlyPromisePipeline(value: boolean) {
    $.utils.setBit(130, value, this, Call._zap.defaultOnlyPromisePipeline);
  }
...
*/
  get releaseParamCaps(): boolean {
    return $.utils.getBit(32, this, Return._zap.defaultReleaseParamCaps);
  }
  set releaseParamCaps(value: boolean) {
    $.utils.setBit(32, value, this, Return._zap.defaultReleaseParamCaps);
  }
  /**
...
*/
  get noFinishNeeded(): boolean {
    return $.utils.getBit(33, this, Return._zap.defaultNoFinishNeeded);
  }
  set noFinishNeeded(value: boolean) {
    $.utils.setBit(33, value, this, Return._zap.defaultNoFinishNeeded);
  }
...
*/
  get releaseResultCaps(): boolean {
    return $.utils.getBit(32, this, Finish._zap.defaultReleaseResultCaps);
  }
  set releaseResultCaps(value: boolean) {
    $.utils.setBit(32, value, this, Finish._zap.defaultReleaseResultCaps);
  }
  /**
...
*/
  get requireEarlyCancellationWorkaround(): boolean {
    return $.utils.getBit(33, this, Finish._zap.defaultRequireEarlyCancellationWorkaround);
  }
  set requireEarlyCancellationWorkaround(value: boolean) {
    $.utils.setBit(33, value, this, Finish._zap.defaultRequireEarlyCancellationWorkaround);
  }
...
*/
  get attachedFd(): number {
    return $.utils.getUint8(2, this, CapDescriptor._zap.defaultAttachedFd);
  }
  set attachedFd(value: number) {
    $.utils.setUint8(2, value, this, CapDescriptor._zap.defaultAttachedFd);
  }
